...
export default function Home() {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatus(result.message); event.currentTarget.reset();
  ...
  return <main>
    <header className="nav">
      <a className="brand" href="#home" aria-label="Signage Times home">ST<span>CO.</span></a>
