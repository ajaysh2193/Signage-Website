...
const services = [
  ...
  ["03", "Design to install", "Accountable team — from concept and production to a precise, dependable installation."],
];
...
export default function Home() {
  ...
  return <main>
    ...
    <footer><a className="brand" href="#home">APEX <span>SIGNWORKS</span></a><p>© {new Date().getFullYear()} Apex Signworks</p><a href="#home">Back to top ↑</a></footer>
  </main>;
}
